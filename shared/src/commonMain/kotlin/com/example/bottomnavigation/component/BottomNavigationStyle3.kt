...
fun BottomNavigationBar3(navController: NavController) {
    ...
    NavigationBar(
        ...
        val currentRoute =
            navBackStackEntry?.destination?.route ?: SimpleNavigationScreens.Home.route
            ...
            NavigationBarItem(
                icon = {
                        Icon(
                            ...
                            modifier = Modifier.height(if (isSelected) 18.dp else 20.dp).width(if(isSelected) 18.dp else 20.dp)
                        )
                },
                selected = isSelected,
                onClick = {
                ...
                colors = NavigationBarItemDefaults.colors(
                    ...
                    indicatorColor = AppTheme.colors.navigation3IconBackgroundColor,
...
@Preview
@Composable
fun PreviewBottomNavigationBar3() {
